...
import com.okkysqlite.sqlite_okky_table_crud.model.TakenSubject;

import java.util.ArrayList;
import java.util.List;

import static com.okkysqlite.sqlite_okky_table_crud.util.Constants.STUDENT_ID;
...
public class SubjectAssignActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_penugasan_mata_pelajaran);
