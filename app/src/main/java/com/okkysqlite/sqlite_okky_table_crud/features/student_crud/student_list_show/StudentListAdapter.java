package com.okkysqlite.sqlite_okky_table_crud.features.student_crud.student_list_show;
...
import com.okkysqlite.sqlite_okky_table_crud.database.*;
import com.okkysqlite.sqlite_okky_table_crud.features.student_crud.StudentCrudListener;
import com.okkysqlite.sqlite_okky_table_crud.features.student_crud.student_update.StudentUpdateDialogFragment;
import com.okkysqlite.sqlite_okky_table_crud.features.taken_subject_crud.taken_subject_show.StudentTakenSubjectActivity;
import com.okkysqlite.sqlite_okky_table_crud.model.Student;
...
public class StudentListAdapter extends RecyclerView.Adapter<StudentViewHolder> {
    ...
    public StudentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_kartu_mahasiswa, parent, false);
