...
import com.okkysqlite.sqlite_okky_table_crud.database.QueryContract;
import com.okkysqlite.sqlite_okky_table_crud.database.QueryResponse;
import com.okkysqlite.sqlite_okky_table_crud.database.TakenSubjectQueryImplementation;
...
public class TakenSubjectListAdapter extends RecyclerView.Adapter<TakenSubjectViewHolder> {
    ...
    public TakenSubjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_mata_kuliah_yang_diambil, parent, false);
